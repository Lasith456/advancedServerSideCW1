...
export default function SingleCountry() {
  ...
  const fetchSingleCountry = async () => {
    ...
    try {
      ...
      setError(err.response?.data?.message || "Failed to fetch country details");
      setTimeout(() => {
        setError("");
      }, 5000);
    } finally {
  ...
  return (
    <Card className="shadow-sm">
      <Card.Body>
        <Card.Title className="mb-4">Search Country</Card.Title>
          ...
          <Form.Group className="mb-3">
            ...
            <InputGroup>
              ...
              <Button 
                ...
                disabled={loading || !apikey || !countryName}
              >
                <FaSearch />
              </Button>
            </InputGroup>
        ...
        {countries.length > 0 ? (
          ...
          !loading && <p className="text-muted mt-3">No country data to display. Please enter a country name and search.</p>
        )}
      </Card.Body>
    </Card>
  );
